                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              personalInformationController.userDetailsData.value.data?.vendor?.businessDocument?.moaOfCompany?.split(".").last == "pdf"?
                              Text(personalInformationController.userDetailsData.value.data?.vendor?.businessDocument?.moaOfCompany!.split("/").last ?? ""):
                              CachedNetworkImage(
                                  imageUrl:  personalInformationController.userDetailsData.value.data?.vendor?.businessDocument?.moaOfCompany ?? "",
                                  scale: 4,
