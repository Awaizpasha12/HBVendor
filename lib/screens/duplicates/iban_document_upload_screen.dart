                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              personalInformationController.userDetailsData.value.data?.vendor?.businessDocument?.ibanCertificate?.split(".").last == "pdf"?
                              Text(personalInformationController.userDetailsData.value.data?.vendor?.businessDocument?.ibanCertificate!.split("/").last ?? ""):
                              CachedNetworkImage(
                                  imageUrl:  personalInformationController.userDetailsData.value.data?.vendor?.businessDocument?.ibanCertificate ?? "",
                                  scale: 4,
